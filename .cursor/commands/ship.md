...
4. Group the changes into logical, atomic commits — each commit should represent one coherent unit of work (a new utility module, a refactored hook, a new component). Avoid bundling unrelated changes into one commit.
